...
def get_SWMT_heat(ds): 
    ...
    ds_heat = ds_heat.drop_vars(["boundary_fluxes_heat"])
...
def get_SWMT_salt(ds, combine_precipitation = True, combine_P_minus_E = True): 
    ...
    if combine_P_minus_E: 
        ds_salt["SWMT_salt_precip_minus_evaporation"] = ds_salt["SWMT_salt_precipitation"] + ds_salt["SWMT_salt_evaporation"]
        ds_salt = ds_salt.drop_vars(["SWMT_salt_precipitation", "SWMT_salt_evaporation"])
